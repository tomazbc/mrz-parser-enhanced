...
trait CountryMapper
{
     ...
     * Supports both ISO 3166-1 alpha-2 and alpha-3 codes
     * Alpha-2 codes are checked first for better performance
     *
    ...
    public function mapCountry(string $code = null): ?string
    {
        ...
        // Check alpha-2 codes first (2 characters)
        if (strlen($code) === 2 && array_key_exists($code, $this->alpha2Countries)) {
            return $this->alpha2Countries[$code];
        }

        // Fall back to existing alpha-3 and special categories
